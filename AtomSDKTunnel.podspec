Pod::Spec.new do |spec|
  ...
  # ――― Frameworks ―――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――― #
  #
  #  Specify the frameworks to include with the Pod.
  #
  spec.vendored_frameworks = [
    'AtomSDKTunnel.xcframework',
    'AtomOVPNTunnel.xcframework',
    'OpenVPNClient.xcframework',
    'LZ4.xcframework',
    'mbedTLS.xcframework'
  ]
  ...
  # ――― Compiler Settings ――――――――――――――――――――――――――――――――――――――――――――――――――――― #
  #
  #  Define compiler flags and other build-related settings.
  #
  spec.xcconfig = {
    'ENABLE_BITCODE' => 'NO', # Disable bitcode for compatibility
    'EXCLUDED_ARCHS[sdk=iphonesimulator*]' => 'arm64', # Exclude arm64 for simulators
  #  'SWIFT_VERSION' => '5.5' # Set the Swift version to match the framework
  }
